...
{   //bool success = false;
    ...
    cmdPassWord[1] = 1;                              /* The quantity number of the _maxium card that can be detected in every research*/
    cmdPassWord[2] = 0x60;                          
    cmdPassWord[3] = block;
    unsigned char sum=0,count=0;
...
struct card DFRobot_PN532::getInformation(){
    ...
    cmdnfcUid[1] = 1;                              // The quantity number of the _maxium card that can be detected in every research
...
bool DFRobot_PN532_IIC::waitRe_mind(){
